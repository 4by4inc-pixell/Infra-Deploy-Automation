...
module "ray-train-cluster" {
  ...
  ray_autoscaler_idle_timeout_seconds=600
  ray_version = "2.47.1"
  ...
  ray_cpuworker_cpu_use = "3600m"
  ray_cpuworker_ram_use = "8Gi"
  ray_cpuworker_replica_min = 0
  ray_cpuworker_replica_max = 64
  ray_gpuworker_cpu_use = "3600m"
  ray_gpuworker_ram_use = "16Gi"
  ray_gpuworker_gpu_use = "1"
  ray_gpuworker_replica_min = 0
  ray_gpuworker_replica_max = 64
  templatefile_path="ray-cluster-v2.yaml"
}
